...
> 2. Update #file:octofit-tracker/backend/octofit_tracker/views.py to replace the return for the REST API URL endpoints with the codespace URL https://redesigned-spork-g6pj46rr9hpp6x-8000.app.github.dev for Django and avoid certificate HTTPS issues.
> 3. Make sure the Django backend works on redesigned-spork-g6pj46rr9hpp6x-8000.app.github.dev and localhost:8000.
